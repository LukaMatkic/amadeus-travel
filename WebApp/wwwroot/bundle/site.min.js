 ...
 * Licensed under MIT (https://github.com/silviomoreto/bootstrap-select/blob/master/LICENSE)
 */
!function(n,t){"function"==typeof define&&define.amd?define(["jquery"],function(n){return t(n)}):"object"==typeof module&&module.exports?module.exports=t(require("jquery")):t(n.jQuery)}(this,function(n){!function(n){n.fn.selectpicker.defaults={noneSelectedText:"Odaberite stavku",noneResultsText:"Nema rezultata pretrage {0}",countSelectedText:function(n){return 1==n?"{0} stavka selektirana":"{0} stavke selektirane"},maxOptionsText:function(n,t){return[1==n?"Limit je postignut ({n} stvar maximalno)":"Limit je postignut ({n} stavke maksimalno)",1==t?"Grupni limit je postignut ({n} stvar maksimalno)":"Grupni limit je postignut ({n} stavke maksimalno)"]},selectAllText:"Selektiraj sve",deselectAllText:"Deselektiraj sve",multipleSeparator:", "}}(n)});$(document).ready(function(){$("#dateDeparture,#dateArrival").datepicker({autoclose:!0,language:"hr",format:"dd.mm.yyyy.",todayHighlight:!0,todayBtn:!0,weekStart:1});$("#dateDeparture").datepicker("update",moment().format("DD.MM.YYYY"));$("#dateArrival").datepicker("update",moment().add(1,"day").format("DD.MM.YYYY"));$("#personNum").val(1);$("#airportDepartment,#airportArrival").selectpicker("refresh");$("#airportDepartmentDiv .form-control input").on("keyup",function(){reloadAirport("#airportDepartment",$(this).val())});$("#airportArrivalDiv .form-control input").on("keyup",function(){reloadAirport("#airportArrival",$(this).val())})});$("#btnSearchNow").click(function(){$("#airportDepartment").selectpicker("toggle")});$("#personNum").change(function(){var n=$("#personNum").val();n<1?$("#personNum").val(1):n>50&&$("#personNum").val(50);$("#personNum").parent().removeClass("has-error")});$("#airportDepartment,#airportArrival").change(function(){$(this).val()!==null&&$(this).parent().parent().removeClass("has-error")});$("#dateDeparture,#dateArrival").change(function(){var n=moment($("#dateDeparture").val(),"DD.MM.YYYY."),t=moment($("#dateArrival").val(),"DD.MM.YYYY.");moment(n).startOf("day")>=moment().startOf("day")&&n<t&&$("#dateDeparture").parent().removeClass("has-error");t>n&&$("#dateArrival").parent().removeClass("has-error")});$("#btnSearch").click(function(){var r=$("#airportDepartment").val(),u=$("#airportArrival").val(),n=moment($("#dateDeparture").val(),"DD.MM.YYYY."),t=moment($("#dateArrival").val(),"DD.MM.YYYY."),i=$("#personNum").val(),f=$("#travelCurrency").val();(r===null&&$("#airportDepartment").parent().parent().addClass("has-error"),u===null&&$("#airportArrival").parent().parent().addClass("has-error"),(moment(n).startOf("day")<moment().startOf("day")||n>=t)&&$("#dateDeparture").parent().addClass("has-error"),t<=n&&$("#dateArrival").parent().addClass("has-error"),(i<1||i>50)&&$("#personNum").parent().addClass("has-error"),$(".has-error").length)||($(".panel").fadeOut(),$("#loader-panel").fadeIn(),$("#table-panel tbody").empty(),$.ajax({type:"GET",url:"/Flight/Search",data:{origin:r,destination:u,departure:moment(n).format("YYYY/MM/DD HH:mm:ss"),return_date:moment(t).format("YYYY/MM/DD HH:mm:ss"),adults:i,currency:f},contentType:"application/json; charset=utf-8",dataType:"text",success:function(n){if($("#loader-panel").fadeOut(),n==="Error"){alert("Dogodila se pogreška na poslužitelju !");return}var t=jQuery.parseJSON(n);if(t.length===0||n===""){$("#noresult-panel").fadeIn();return}displayOffersData(t)},error:function(){$("#loader-panel").fadeOut();alert("Dogodila se pogreška na poslužitelju !")}}))});